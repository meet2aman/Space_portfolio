      ...
      <div className="w-full flex flex-col items-center justify-center m-auto">
        <div className="w-full h-full flex flex-row items-center justify-around flex-wrap">
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start z-20">
            ...
            <p className="flex flex-row items-center my-[15px] cursor-pointer z-20 hover:scale-110 transition-all">
              <FaYoutube />
          ...
          <div className="min-w-[200px] h-auto flex flex-col items-center justify-start">
            ...
            <p className="flex flex-row items-center my-[15px] cursor-pointer">
              <span className="text-[15px] ml-[6px] cursor-pointer z-20 hover:scale-110 transition-all">
